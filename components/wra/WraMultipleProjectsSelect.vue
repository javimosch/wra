<template>
	<div class="WraMultipleProjectsSelect">
		<div class="row no-gutters">
			<div class="col-12" v-show="label">
				<LightLabel v-html="label"></LightLabel>
			</div>
			<div class="col-12">
				<WraProjectsSelect ref="select" v-model="item._id" @change="change" @clear="clear"></WraProjectsSelect>
			</div>
...
<script>
	...
	export default {
		name: 'WraMultipleProjectsSelect',
		props:['value','label'],
		fetch(){
